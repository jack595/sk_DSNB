...
class TrainTool:
    def __init__(self):
        ...
        # Joint Setting
        self.list_keys_from_evtTruth = ["evtType"]
    ...
    def PrepareInput(self):
        ...
        v_dict = [self.dir_PSD_diff_particle[key] for key in v_keys]
        for dir in v_dict:
            self.FilterForEvents(dir, self.filter)

        # Align Events Entries
        (self.n_events,self.dir_cut_off) = AlignEventsByTag(v_dict, v_tags_in_train=set( list(self.map_tag_particles.values()) ),
...
if __name__ == '__main__':
    ...
    path_PSDTools = f"/afs/ihep.ac.cn/users/l/luoxj/PSD_Supernova/myJUNOCommon/share/PSD/root{train_tool.option_time_profile}/user_PSD_"+"{}_SN.root"
